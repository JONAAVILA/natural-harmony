...
export { default as LenguageIcon } from './icons/lenguage/Lenguage.icon'
export { default as LoadIcon } from './icons/loader/LoadIcon'
export { default as Whatsapp } from './icons/whatsapp/Whatsapp'
export { default as Cross } from './icons/cross/Cross'

export { default as Alert } from './modals/alerts/Alert.modal'
export { default as ValidateCode } from './modals/validateCode/ValidateCode.modals'
